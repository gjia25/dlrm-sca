...
def scatterplot(ylabel, filepath_to_time_to_values, run):
    ...
    axes.set_xlim([0, NUM_RUNS + 1])
    axes.set_xticks(list(range(1, NUM_RUNS + 1)))
...
def check_no_distinct_pages(filepath_to_time_to_pfns, filepath_to_time_to_vas):
...
def get_filepath_to_run_to_values(lst_filepath_to_time_to_values):
    ...
    print(filepath_to_run_to_values)
...
if __name__ == '__main__':
    ...
    if check_no_distinct_pages(filepath_to_run_to_pfns, filepath_to_run_to_vas):
